    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-serif text-lg mb-4">FindMyScent</h3>
            <p className="text-gray-400 text-sm">
              Crafting exceptional fragrances since 1998. Our perfumes are created with the finest ingredients sourced from around the world.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Fragrance Guides</a></li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} FindMyScent. All rights reserved.
          </p>
